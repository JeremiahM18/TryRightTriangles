...
/**
 * ReentrantLock-based implementation of Buffet interface.
 *
 * <p>This class coordinates server threads (adding slices) and patron
 * threads (taking slices) using a {@link ReentrantLock} and condition
 * variables. The buffet is modeled as a FIFO queue where the oldest
 * slice is removed first.</p>
 *
 *<p>Concurrency logic is deferred for later development.</p>
 *
 */
public class BuffetLock implements Buffet{

    /**
     * Maximum nuber of slices allowed on the buffet at any time.
     */
    ...
    /**
     * Condition signaled when slices may be added (space become available).
     */
    ...
    public List<SliceType> TakeAny(final int desired){
        ...
        // TODO: wait until desired eligible slices are available or buffet is closed
    ...
    public List<SliceType> TakeVeg(final int desired){
        ...
        // TODO: wait until desired vegetarian slices are available or buffet is closed
        // TODO: return slices in FIFO order
        return null;
    }
    ...
    public boolean AddPizza(final int count, final SliceType stype) {
        ...
        // TODO: add slices up to capacity; wait if remaining slices cannot be added yet
    ...
    @Override
    public void close() {
        // TODO: acquire lock, mark closed, and signal all waiting threads
    }
}
